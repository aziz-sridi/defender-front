...
import GameCard from '@/components/user/settings/sidebarTabs/helpers/GameCard'
      ...
      <div className="bg-defendrBg rounded-lg p-8 relative max-h-[90vh] w-[80vw] max-w-4xl flex flex-col">
        ...
        <div className="flex-shrink-0">
          <div className="text-center mb-8">
            <Typo as="h1" className="font-bold font-poppins" color="red" fontVariant="h2">
              Select A GAME
            </Typo>
          </div>
          ...
          <div className="mb-6 text-center">
            <Typo as="h3" className="font-poppins" color="white" fontVariant="p1">
              Most Recent Games
            </Typo>
          </div>
        </div>
