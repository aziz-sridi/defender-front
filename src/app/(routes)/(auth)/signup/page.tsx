...
import SignUpForm from '@/components/home/loginSignupForms/SignUpForm'
import PlatformSignUp from '@/components/home/loginSignupForms/PlatformSignUp'
  ...
  return (
    <section className="flex bg-defendrBg flex-col lg:flex-row overflow-hidden lg:h-screen relative">
      ...
      <div
        ...
        style={{ backgroundImage: `url(/assets/images/Signup.jpg)` }}
      />
      ...
      {/* Form panel */}
      <aside className="flex-1 flex flex-col items-center justify-start lg:justify-center px-5 py-6 lg:py-0 min-h-[80vh] lg:min-h-screen overflow-y-auto">
        <div className="w-full max-w-sm">
          {/* Heading */}
          <div className="mb-5 text-center lg:text-left">
            <h1 className="text-2xl lg:text-4xl font-bold text-white font-poppins">
              Create an account
            </h1>
            <p className="text-gray-400 text-sm font-poppins mt-1.5">
              Join the DEFENDR esports community
            </p>
          </div>
          ...
          {/* Footer link */}
          <p className="text-center text-sm text-gray-400 font-poppins mt-6 mb-8">
