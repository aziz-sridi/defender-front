...
export default function TSFPage() {
  const [organizationTournaments, setOrganizationTournaments] = useState<any[]>([])
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState<string | null>(null)

  // Organization ID for TSF (from your example tournament record)
    ...
    <div className="min-h-screen bg-[#161616] text-white p-4 sm:p-5 md:p-10 relative overflow-hidden">
      ...
      <div className="w-full relative z-10">
        ...
        <div className="text-center py-10">
          ...
          {/* TSF Event Website Button */}
          <div className="mb-8 flex justify-center">
            <Button
              label="TSF Event Website"
              size="l"
              variant="contained-red"
              className="px-8 py-4 text-lg font-bold"
              onClick={() => window.open('https://tsf.tn/', '_blank')}
            />
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 rounded-xl p-4 sm:p-6 border-2 border-gray-500 shadow-xl">
            <div className="flex items-center justify-center gap-2 sm:gap-4">
              <div className="text-2xl sm:text-4xl hidden sm:block">🏁</div>
              <div className="text-center flex-1">
                ...
                <Typo
                  ...
                  fontVariant="p3"
                >
                  The TSF 2025 tournament has concluded. Thank you to all participants!
                </Typo>
              </div>
              <div className="text-2xl sm:text-4xl hidden sm:block">🏁</div>
            </div>
        ...
        <div className="mt-12">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <Typo as="p" color="ghostGrey" fontFamily="poppins" fontVariant="p4">
                Check back later for TSF tournaments
              </Typo>
            </div>
          )}
        </div>
          ...
          <div className="space-y-4">
            ...
            <details className="group bg-gray-800/80 rounded-xl border border-gray-700 overflow-hidden">
              ...
              <div className="px-4 sm:px-6 pb-5 text-gray-200 space-y-3">
                ...
                <div>
                  <span className="font-semibold text-white">17 – 25 Oct</span> · League of Legends
                  5v5
                  <div className="text-sm text-gray-400">
                    Opens 17 Oct, closes 25 Oct · Playing 27–28
                  </div>
                </div>
                <div>
            ...
            <details className="group bg-gray-800/80 rounded-xl border border-gray-700 overflow-hidden">
              ...
              <div className="px-4 sm:px-6 pb-5 text-gray-200 space-y-3">
                ...
                <div>
                  <span className="font-semibold text-white">27–28 Oct</span> · League of Legends
                  5v5 (½)
                </div>
                <div>
